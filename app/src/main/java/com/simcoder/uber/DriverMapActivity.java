...
public class DriverMapActivity extends FragmentActivity implements OnMapReadyCallback, RoutingListener {
    ...
    private void getAssignedCustomerInfo(){
        ...
        //open activity all route on map and can open indications on maps
    }
    ...
    private void recordRide(){
        ...
        map.put("distance", rideDistance); //check this the problm is not actually moving
        historyRef.child(requestId).updateChildren(map);
        //manage also a current location when de endTRip is diferent to destiny
    }
